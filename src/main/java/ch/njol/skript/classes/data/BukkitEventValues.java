...
public final class BukkitEventValues {
	...
	public static void register(EventValueRegistry registry) {
		...
		registry.register(EventValue.simple(ExperienceSpawnEvent.class, Location.class, ExperienceSpawnEvent::getLocation));
		registry.register(EventValue.simple(ExperienceSpawnEvent.class, Experience.class, event -> new Experience(event.getSpawnedXP())));
